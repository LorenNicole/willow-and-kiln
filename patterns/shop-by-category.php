...
<div class="wp-block-group alignwide">
	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column">
			...
			<!-- /wp:image -->
			<!-- wp:heading {"level":3,"fontSize":"heading-small"} -->
			<h3 class="wp-block-heading has-heading-small-font-size">Ceramics</h3>
			<!-- /wp:heading -->
			<!-- wp:buttons -->
		...
		<div class="wp-block-column">
			...
			<!-- /wp:image -->
			<!-- wp:heading {"level":3,"fontSize":"heading-small"} -->
			<h3 class="wp-block-heading has-heading-small-font-size">Candles</h3>
			<!-- /wp:heading -->
			<!-- wp:buttons -->
			<div class="wp-block-buttons">
				<!-- wp:button {"className":"is-style-outline"} -->
		...
		<div class="wp-block-column">
			...
			<!-- /wp:image -->
			<!-- wp:heading {"level":3,"fontSize":"heading-small"} -->
			<h3 class="wp-block-heading has-heading-small-font-size">Jewelry</h3>
			<!-- /wp:heading -->
			<!-- wp:buttons -->
			<div class="wp-block-buttons">
				<!-- wp:button {"className":"is-style-outline"} -->
	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column">
			...
			<!-- /wp:image -->
			<!-- wp:heading {"level":3,"fontSize":"heading-small"} -->
			<h3 class="wp-block-heading has-heading-small-font-size">Paper</h3>
			<!-- /wp:heading -->
			<!-- wp:buttons -->
			<div class="wp-block-buttons">
				<!-- wp:button {"className":"is-style-outline"} -->
		...
		<div class="wp-block-column">
			...
			<!-- /wp:image -->
			<!-- wp:heading {"level":3,"fontSize":"heading-small"} -->
			<h3 class="wp-block-heading has-heading-small-font-size">Textiles</h3>
			<!-- /wp:heading -->
			<!-- wp:buttons -->
			<div class="wp-block-buttons">
				<!-- wp:button {"className":"is-style-outline"} -->
		...
		<div class="wp-block-column">
			...
			<!-- /wp:image -->
			<!-- wp:heading {"level":3,"fontSize":"heading-small"} -->
			<h3 class="wp-block-heading has-heading-small-font-size">Home</h3>
			<!-- /wp:heading -->
			<!-- wp:buttons -->
			<div class="wp-block-buttons">
				<!-- wp:button {"className":"is-style-outline"} -->
